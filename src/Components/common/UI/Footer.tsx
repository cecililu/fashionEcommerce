...
export const Footer = () => {
  return (
    ...
    <footer className="bg-cyan-200 mt-20">
        ...
        <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https:">CilStores Nepal™</a>. All Rights Reserved.
            </span>
